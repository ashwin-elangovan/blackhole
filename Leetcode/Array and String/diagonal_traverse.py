class Solution:
    ...
    # Based on sum
		# loop through matrix
        for i in range(len(matrix)): # Whole matrix
            for j in range(len(matrix[i])): # Elements of matrix
        ...
        # Now, Response will be something like this: {0: [1], 1: [2, 4], 2: [3, 5, 7], 3: [6, 8], 4: [9]}
        ans= []
